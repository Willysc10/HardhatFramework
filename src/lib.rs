// src/lib.rs
/*
 * Core library for HardhatFramework
 */
...
#[derive(Debug)]
pub struct HardhatFrameworkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HardhatFrameworkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HardhatFramework processing");
    
    let mut processor = HardhatFrameworkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HardhatFrameworkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HardhatFrameworkProcessor::new(false);
